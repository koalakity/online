...
public class AccountUserInfoJobAdmin implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2058347708670749906L;
	...
	/** default constructor */
	public AccountUserInfoJobAdmin() {
	}

	/** minimal constructor */
	public AccountUserInfoJobAdmin(BigDecimal userId) {
		this.userId = userId;
	}

	/** full constructor */
	public AccountUserInfoJobAdmin(BigDecimal userId, String corporationName,
			BigDecimal corporationKind, BigDecimal corporationIndustry,
			BigDecimal corporationScale, String position,
			BigDecimal jobProvince, BigDecimal jobCity,
			BigDecimal presentCorporationWorkTime, String corporationPhoneArea,
			String corporationPhone, String jobEmail,
			String corporationAddress, String corporationWeb) {
		this.userId = userId;
