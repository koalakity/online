...
public class FinancialAcTCustomerAdmin implements java.io.Serializable {
	...
	private Set<AcTLedgerAdmin> acTLedgerAdmins=new HashSet<AcTLedgerAdmin>();
	
	private AccountUsersAdmin accountUsersAdmin;
	
	@OneToOne(mappedBy="financialAcTCustomerAdmin")
	...
	@OneToMany(mappedBy="financialAcTCustomerAdmin")
	public Set<AcTLedgerAdmin> getAcTLedgerAdmins() {
		return acTLedgerAdmins;
	}

	public void setAcTLedgerAdmins(Set<AcTLedgerAdmin> acTLedgerAdmins) {
		this.acTLedgerAdmins = acTLedgerAdmins;
	}

	/** default constructor */
	public FinancialAcTCustomerAdmin() {
	}
