...
public class AccountUserInfoPersonAdmin implements java.io.Serializable {
...
//    private String userRemarks; //备注字段
    ...
    /** default constructor */
    public AccountUserInfoPersonAdmin() {
    }

    /** minimal constructor */
    public AccountUserInfoPersonAdmin(BigDecimal infoId) {
        this.infoId = infoId;
    }

    /** full constructor */
    public AccountUserInfoPersonAdmin( String headPath, String realName,
            ...
            String graduatSchool, Timestamp birthday, String degreeNo,
...
//	@Column(name = "USER_REMARKS", length = 40)
