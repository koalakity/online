...
@JsonIdentityInfo(generator = ObjectIdGenerators.IntSequenceGenerator.class, property = "@acTLedgerLoanAdminId")
public class AcTLedgerLoanAdmin implements java.io.Serializable {
	...
	private Set<AcTVirtualCashFlowAdmin> acTVirtualCashFlows = new HashSet<AcTVirtualCashFlowAdmin>();


	// Constructors

	/** default constructor */
	public AcTLedgerLoanAdmin() {
	}
	...
	@OneToOne(mappedBy="loanAcTLedgerLoan")
	...
	@OneToMany(mappedBy = "acTLedgerLoanAdmin")
	public Set<AcTVirtualCashFlowAdmin> getAcTVirtualCashFlows() {
		return acTVirtualCashFlows;
	}

	public void setAcTVirtualCashFlows(
			Set<AcTVirtualCashFlowAdmin> acTVirtualCashFlows) {
