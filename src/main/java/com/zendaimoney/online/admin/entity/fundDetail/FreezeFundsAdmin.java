...
public class FreezeFundsAdmin implements java.io.Serializable {


	private FreezeFundsAdmin id;
	...
	/** default constructor */
	public FreezeFundsAdmin() {
	}

	/** full constructor */
	public FreezeFundsAdmin(BigDecimal freezeId, String freezeKind,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FreezeFundsAdmin))
			return false;
		FreezeFundsAdmin castOther = (FreezeFundsAdmin) other;
