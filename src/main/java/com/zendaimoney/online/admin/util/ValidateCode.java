...
public class ValidateCode {
	...
	public void createCode(HttpServletRequest req, HttpServletResponse resp,String validateCode) throws IOException {
	 ...
	 * description:验证
	 */
	public static Boolean CodeValidate(HttpServletRequest request,String type,String validateCode){
		String code = (String) request.getSession().getAttribute(type);
