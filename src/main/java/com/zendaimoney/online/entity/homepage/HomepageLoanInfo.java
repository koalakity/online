...
public class HomepageLoanInfo implements java.io.Serializable {
	...
	// private List<HomepageInvestInfo> investInfoList;

	// Constructors

	/** default constructor */
	public HomepageLoanInfo() {
	}
	...
	// @OneToMany(cascade={CascadeType.ALL},mappedBy="loanInfo")
	// public List<HomepageInvestInfo> getInvestInfoList() {
	// return investInfoList;
	// }
	//
	// public void setInvestInfoList(List<HomepageInvestInfo> investInfoList) {
