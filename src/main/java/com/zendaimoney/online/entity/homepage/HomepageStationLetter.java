...
public class HomepageStationLetter implements java.io.Serializable {

	private static final long serialVersionUID = 4000091645068748561L;
	...
	private HomepageLoanInfo loanId;
	...
	public HomepageLoanInfo getLoanId() {
		return this.loanId;
	}

	public void setLoanId(HomepageLoanInfo loanId) {
		this.loanId = loanId;
	}
