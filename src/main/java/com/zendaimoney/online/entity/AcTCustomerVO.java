 ...
 */
@Entity(name="AcTCustomerVO")
@Table(name = "AC_T_CUSTOMER")
public class AcTCustomerVO implements java.io.Serializable {
	...
	/** default constructor */
	public AcTCustomerVO() {
	}

	/** minimal constructor */
	public AcTCustomerVO(String customerNo, String name, String totalAcct) {
	...
	/** full constructor */
	public AcTCustomerVO(String customerNo, String type, String name,
