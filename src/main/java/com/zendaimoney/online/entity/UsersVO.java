...
public class UsersVO implements java.io.Serializable {
	...
	/** minimal constructor */
	public UsersVO(String loginName, String loginPassword, String email, Long isapproveEmail, String regIp, Date regTime, Long loginCount, Long loginStatus, Date loginTimeLast, String loginIpLast) {
	...
	/** full constructor */
	public UsersVO(String loginName, String loginPassword, String email, Long isapproveEmail, String regIp, Date regTime, Long loginCount, Long loginStatus, Date loginTimeLast, String loginIpLast, Long statusView, Long regType, Long isApprovePhone, Long isApproveCard) {
		this.loginName = loginName;
		this.loginPassword = loginPassword;
		this.email = email;
		this.isapproveEmail = isapproveEmail;
