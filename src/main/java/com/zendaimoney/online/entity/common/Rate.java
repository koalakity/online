...
public class Rate implements java.io.Serializable {
	...
	/** full constructor */
	public Rate(BigDecimal withdraw, BigDecimal recharge, BigDecimal overdueInterest, BigDecimal overdueFines, BigDecimal earlyFines, BigDecimal mgmtFee, Date opDate, String note) {
