 ...
 */
@Entity(name="AcTFlowVO")
@Table(name = "AC_T_FLOW")
public class AcTFlowVO implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6732392779528272091L;
	private Long id;
	...
	@Column(name = "ACCT_TITLE", nullable = false, length = 11)
	...
	@Column(name = "APPO_ACCT_TITLE", length = 11)
