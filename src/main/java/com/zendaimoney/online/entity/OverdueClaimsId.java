 ...
 */
@Embeddable
public class OverdueClaimsId implements java.io.Serializable {
	...
	/** default constructor */
	public OverdueClaimsId() {
	}

	/** full constructor */
	public OverdueClaimsId(Long investId, Long num) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OverdueClaimsId))
			return false;
		OverdueClaimsId castOther = (OverdueClaimsId) other;
