...
public class StationMessageUserApprove implements java.io.Serializable {
	...
	private StationMessageUserApprovePro proId;
	...
	/** default constructor */
	public StationMessageUserApprove() {
	}

	/** minimal constructor */
	public StationMessageUserApprove(BigDecimal userApproveId, BigDecimal userId, StationMessageUserApprovePro proId, BigDecimal proStatus, Date auditTime, BigDecimal creditScore, BigDecimal auditerId) {
	...
	/** full constructor */
	public StationMessageUserApprove(BigDecimal userApproveId, BigDecimal userId, StationMessageUserApprovePro proId, BigDecimal proStatus, Date auditTime, BigDecimal creditScore, BigDecimal auditerId, BigDecimal reviewStatus, Date createTime, Date updateTime) {
		this.userApproveId = userApproveId;
		this.userId = userId;
		this.proId = proId;
		this.proStatus = proStatus;
	...
	public StationMessageUserApprovePro getProId() {
		return proId;
	}

	public void setProId(StationMessageUserApprovePro proId) {
		this.proId = proId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StationMessageUserApprove))
			return false;
		StationMessageUserApprove castOther = (StationMessageUserApprove) other;
