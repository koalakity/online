 ...
 */
@Entity(name="AcTLedgerLoanVO")
@Table(name = "AC_T_LEDGER_LOAN")
public class AcTLedgerLoanVO implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1675621193932608096L;
	private Long id;
