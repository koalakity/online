...
public class LoanManagementUserInfoPerson implements java.io.Serializable {
	...
	/** default constructor */
	public LoanManagementUserInfoPerson() {
	}

	/** minimal constructor */
	public LoanManagementUserInfoPerson(BigDecimal userId) {
		this.userId = userId;
	}
