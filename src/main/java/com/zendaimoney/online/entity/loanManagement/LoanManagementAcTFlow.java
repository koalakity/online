...
public class LoanManagementAcTFlow implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6221094694771189092L;
	private Long id;
	...
	/** default constructor */
	public LoanManagementAcTFlow() {
	}

	/** minimal constructor */
	public LoanManagementAcTFlow(String tradeType, String account, String acctTitle) {
	...
	/** full constructor */
	public LoanManagementAcTFlow(Date tradeDate, String tradeNo, String tradeCode,
			Double tradeAmount, String dorc, String tradeType,
			String reversedNo, String tradeKind, String voucherKind,
			String voucherCode, String teller, String delegationTeller,
			String organ, String account, String acctTitle, String appoAcct,
			String appoAcctTitle, String memo, String memo2, String memo3) {
