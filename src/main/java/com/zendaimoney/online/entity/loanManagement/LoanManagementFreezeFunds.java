...
public class LoanManagementFreezeFunds implements java.io.Serializable {
	...
	/** default constructor */
	public LoanManagementFreezeFunds() {
	}

	/** full constructor */
	public LoanManagementFreezeFunds(String freezeKind, BigDecimal userId, BigDecimal loanId,
