...
/**
 * PayAcTCustomer entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "AC_T_CUSTOMER")
public class PayAcTCustomer implements java.io.Serializable {
	...
	/** default constructor */
	public PayAcTCustomer() {
	}

	/** minimal constructor */
	public PayAcTCustomer(String customerNo, String name, String totalAcct) {
	...
	/** full constructor */
	public PayAcTCustomer(String customerNo, String type, String name,
