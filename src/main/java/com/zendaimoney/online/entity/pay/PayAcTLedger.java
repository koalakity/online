...
public class PayAcTLedger implements java.io.Serializable {
	...
	/** minimal constructor */
	public PayAcTLedger(String account, Long totalAccountId, String busiType) {
	...
	/** full constructor */
	public PayAcTLedger(String account, Long totalAccountId, Date openacctDate,
			String openacctTeller, String busiType, Double amount,
			Double investAmount, Double debtAmount, Double interestReceivable,
			...
			Double payBackAmt, Date cancelacctDate, String memo) {
		this.account = account;
		this.totalAccountId = totalAccountId;
