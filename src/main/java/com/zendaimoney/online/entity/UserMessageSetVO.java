 ...
 */
@Entity(name="UserMessageSetVO")
@Table(name = "USER_MESSAGE_SET")
public class UserMessageSetVO implements java.io.Serializable {
	...
	/** default constructor */
	public UserMessageSetVO() {
	}

	/** full constructor */
	public UserMessageSetVO(Long userId, Long mannerId,Long kindId,
			String description) {
		this.userId = userId;
