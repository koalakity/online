...
public class MyInvestmentAcTFlow implements java.io.Serializable {

	private static final long serialVersionUID = -8567842268786000168L;
	private Long id;
	...
	/** default constructor */
	public MyInvestmentAcTFlow() {
	}

	/** minimal constructor */
	public MyInvestmentAcTFlow(String tradeType, String account, String acctTitle) {
