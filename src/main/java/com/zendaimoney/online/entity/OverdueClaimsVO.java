...
public class OverdueClaimsVO implements java.io.Serializable {
	...
	/** default constructor */
	public OverdueClaimsVO() {
	}

	/** minimal constructor */
	public OverdueClaimsVO(OverdueClaimsId id, Long id_1, Long loanId) {
		this.id = id;
		//this.id_1 = id_1;
		this.loanId = loanId;
	}
	...
	public OverdueClaimsVO(OverdueClaimsId id, Long id_1, Long loanId,
			...
			BigDecimal managerFree, BigDecimal overDueDays, Date createTime,
	...
	public OverdueClaimsId getId() {
		return this.id;
	}

	public void setId(OverdueClaimsId id) {
		this.id = id;
	}
