...
public class FinancialAcTLedger implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3240801848167329315L;
	private Long id;
	...
	/** default constructor */
	public FinancialAcTLedger() {
	}

	/** minimal constructor */
	public FinancialAcTLedger(String account, String busiType) {
		this.account = account;
		this.busiType = busiType;
	}

	/** full constructor */
	public FinancialAcTLedger(String account, Date openacctDate, String openacctTeller,
			String busiType, Double amount, Double investAmount,
			Double debtAmount, Double interestReceivable,
			Double otherReceivale, Double loanAmount, Double interestPayable,
			Double toherPayable, Double interestIncome, Double otherIncome,
			Double nonoperatIncome, Double interestExpenditure,
			Double otherExpenditure, Double nonoperatExpenditure,
			Date cancelacctDate, String memo) {
		this.account = account;
