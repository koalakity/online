...
public class AccountUserloginlog implements java.io.Serializable {
	...
	/** default constructor */
	public AccountUserloginlog() {
	}

	/** full constructor */
	public AccountUserloginlog(BigDecimal userId, Date loginTime, String loginIp,
