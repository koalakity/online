...
public class AcTLedger implements java.io.Serializable {
	...
	/** minimal constructor */
	public AcTLedger(String account, Long totalAccountId, String busiType) {
	...
	/** full constructor */
	public AcTLedger(String account, Long totalAccountId, Date openacctDate,
