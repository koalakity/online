...
<script type="text/javascript">
	var ca = document.getElementById("cAllLoan");
	var ci = document.getElementById("cLoanIng");
	var cf = document.getElementById("cfutureLoan");
	var ce = document.getElementById("cLoanEd");
	
	ca.innerText = "全部借款列表[${count.allLoanCount}]";
	ci.innerText = "进行中的借款[${count.ingLoanCount}]";
	cf.innerText = "即将开始的借款[${count.futureLoanCount}]";
	ce.innerText = "已完成的借款[${count.oldLoanCount}]";
</script>
<div class="invest_c1">
	<table>
		<tr>
		...
		<pg:pager url="${ctx}/financial/searchLoan/futureLoan"
			items="${count.futureLoanCount}" index="center" maxPageItems="10"
		...
		<tr>
			...
			<td>
				<div class="raise_s4">
					<span style="width: 0%;"></span><em>0%</em>
				</div>
				0笔投标，还需￥0.00
				<br />
