...
$(function(){
	...
	$(".account_r_c_t").find("h3").click(function(){
		...
		var loadUrl ="";
		if(m==1){
		   loadUrl = "${ctx}/escrow/escrow/showEscrowRecharge";
		}
		if(m==2){
		   loadUrl = "${ctx}/escrow/escrow/showEscrowWithdraw";
		}
			 $.ajax({
       		 url: loadUrl,
       	 	 type: "POST",
			...
			<div class="account_r_c account_r_c_add">
				...
				<div class="account_r_c_3c">
					<div class="account_r_c_3c1">
						<%@ include file="/WEB-INF/views/escrow/escrowRecharge.jsp"%>				
					</div>
					<div class="account_r_c_3c2" style="display:none;">
						<%@ include file="/WEB-INF/views/escrow/escrowWithdraw.jsp"%>				
					</div>
				</div>
			</div>
