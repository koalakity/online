...
<body>
	<div id="tab" class="easyui-tabs" style="width:1000px;">  
		...
		<div title="还款信息">  
			<table id="table1" class="easyui-datagrid" url="${ctx}/admin/loan/seachLoanRepayList?loanId=${loanInfo.ledgerLoanId}" striped="true" fitColumns="true" style="width:998px; height:527px;" singleSelect="true">
				<thead>
					<tr>
