...
<script type="text/javascript">
	...
	function formatterOperation(val, row) {
		url='${ctx}/admin/loan/loanTenderingDetailPage?loanId='+row.loanId
...
<body>
<table id="dg" title="招标中借款列表" class="easyui-datagrid"
			url="${ctx}/admin/loan/loanTenderingPage?status=1"
...
<div id="toolbar" style="padding:5px;height:auto">
	...
	<div>
		...
		<a href="#" id="searchBt" class="easyui-linkbutton" iconCls="icon-search" onclick="javascriput:search()">搜索</a>
	</div>
