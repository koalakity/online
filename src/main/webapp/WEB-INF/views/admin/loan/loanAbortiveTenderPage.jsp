...
<script type="text/javascript">
	...
	function formatterOperation(val, row) {
		url='${ctx}/admin/loan/loanAbortiveTenderDetailPage?loanId='+row.loanId
...
<body>
<table id="dg" title="流标借款列表" class="easyui-datagrid"
			url="${ctx}/admin/loan/loanInfoPage?status=3"
