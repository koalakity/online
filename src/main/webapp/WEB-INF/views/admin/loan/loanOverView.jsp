...
<script type="text/javascript">
		...
		function passAudit(status){
			$.post(
				"${ctx}/admin/loan/alertLoanStatus", 
...
<body>
	<div id="tab" class="easyui-tabs" style="width:1000px;">  
		<div title="基本信息" style="padding:20px;">  
			...
			<a class="easyui-linkbutton" onclick="popupDiv('div_id',1)">核审通过</a>
			<a  class="easyui-linkbutton" onclick="popupDiv('div_id',3)">不通过，流标处理</a>	
		</div>  
