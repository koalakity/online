...
<script type="text/javascript">
	...
	function editUser(){
		...
		if (row){
			...
			$('#fm').form('load',row);
			url = '${ctx}/admin/user/updateUser?id='+row.id;
		}
	}
	...
	function formatterOperation(val, row) {
		url='${ctx}/admin/loan/loanOverViewJsp?loanId='+row.loanId
...
<body>
<table id="dg" title="待审核借款列表" class="easyui-datagrid"
			url="${ctx}/admin/loan/waitingForAuditloanPage?status=8"
	...
	<form id="serarchForm" method="post" style="margin:0;">
		<table style="font-size:12px;">
			<tr>
				...
				<td>昵称:</td>
				<td><input type="text" name="loginName" id="loginName" size=16/></td>
				<td>手机号码:<input type="text" name="phoneNo" id="phoneNo" size=16/></td>
				渠道名称：<!-- 一级渠道信息 -->
				...
				<td><a href="#" id="searchBt" class="easyui-linkbutton" iconCls="icon-search">搜索</a></td>
			</tr>
		</table>
	</form>
</div>
