...
<script type="text/javascript">
	...
	function formatterOperation(val, row) {
		url='${ctx}/admin/loan/loanJuniorHastenDetailPage?loanId='+row.loanId
	...
	function formattRepayTime(val,row){
		return row.nextExpiry+'<br/>'+'<font color=red >逾期'+row.pastDueDays+'天</font>';
	}
...
<body>
<table id="dg" title="初级催收列表" class="easyui-datagrid"
			url="${ctx}/admin/loan/loanInfoPage?status=6"
	...
	<thead>
		<tr>
			...
			<th field="repayTime" formatter="formattRepayTime" >还款日期</th>
