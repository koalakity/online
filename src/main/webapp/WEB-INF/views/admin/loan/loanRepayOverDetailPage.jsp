...
<body>
	<div id="tab" class="easyui-tabs" style="width:1000px;">  
		...
		<div title="还款信息">  
			<table id="table1" class="easyui-datagrid" url="${ctx}/admin/loan/seachLoanRepayList?loanId=${loanInfo.ledgerLoanId}" striped="true" fitColumns="true" rownumbers="true" style="width:998px; height:527px;" singleSelect="true">
				<thead>
					<tr>
	...
	<div id="d1" modal="true" class="easyui-dialog" title="添加备注" closed="true" style="padding:5px; width:400px; height:200px;" data-options="buttons:'#dlg-buttons'">
		<textarea id="memoText" name="memoText" style="width:370px; height:110px; font-size:12px;" onfocus="if(this.value=='不超过500个汉字！')this.value=''" onblur="if(this.value=='')this.value='不超过500个汉字！'">不超过500个汉字！</textarea>
	</div>
	<div id="dlg-buttons">
		<a class="easyui-linkbutton" onclick="javascript:noteSubmit()">提交</a>
		<a  class="easyui-linkbutton" onclick="noteReset()">取消</a>
	</div>
</body>
</html>