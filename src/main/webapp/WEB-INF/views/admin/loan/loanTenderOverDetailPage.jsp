	...
	function oMemoDlg(){
		...
		function passAudit(status){
			...
			$.post("${ctx}/admin/loan/alertLoanStatus", 
				  { loanId: "${loanInfo.loanId}", status:status,requestToken:"${loanProess}"},
					function (result){
...
<body>
	<div id="tab" class="easyui-tabs" style="width:1000px;">  
		<div title="基本信息" style="padding:20px;">  
			...
			<a class="easyui-linkbutton" onclick="popupDiv('pop-div',4);">确认放款，进入还款阶段</a>
			<a  class="easyui-linkbutton" onclick="history.back();">返回已满标借款列表</a>	
