...
<form:form class="personalEduForm"  enctype="multipart/form-data" method="post" style="margin-bottom:0;">
	<table>
		<tr>
			...
			<td align="left"><select id="maxDegree" name="userInfoPerson.maxDegree" disabled="disabled" > 
					<option value="47"
		...
		<tr>
			...
			<td align="left">
				<input id="graduatSchool" name="userInfoPerson.graduatSchool"	type="text" value="${userbasic.userInfoPerson.graduatSchool}" onkeyup="check(this)" disabled="disabled" />
			</td>
		</tr>
		<tr>
			<td align="right" nowrap>入学年份:</td>
			<td align="left">
				<select name="userInfoPerson.inschoolTime" disabled="disabled" >
		...
		<tr>
			...
			<td align="left">
				<input id="jobTitleOne" name="userInfoPerson.jobTitleOne"	type="text" value="${userbasic.userInfoPerson.jobTitleOne}"	onkeyup="check(this)" disabled="disabled" />
			</td>
		</tr>
		<tr>
			<td align="right" nowrap>职称二:</td>
			<td align="left">
				<input id="jobTitleTwo" name="userInfoPerson.jobTitleTwo" type="text" value="${userbasic.userInfoPerson.jobTitleTwo}" onkeyup="check(this)" disabled="disabled" />
			</td>
		</tr>
		<tr>
			<td align="right" nowrap>职称三:</td>
			<td align="left">
				<input id="jobTitleThr" name="userInfoPerson.jobTitleThr"	type="text" value="${userbasic.userInfoPerson.jobTitleThr}"	onkeyup="check(this)" disabled="disabled" />
			</td>
		</tr>
