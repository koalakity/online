...
<form:form class="privatePropritorForm"  enctype="multipart/form-data" method="post" style="margin-bottom:0;">
	<table>
				<tr>
					...
					<td>
						<select id="sel8" name="privatePropritor.enterpriseKind" disabled="disabled" >
				...
				<tr>
					...
					<td align="left">
						<input type="text" id="establishDate" name="privatePropritor.establishDate" onClick="WdatePicker({dateFmt:'yyyy/MM/dd'})" value="${userbasic.privatePropritor.establishDate}" disabled="disabled" />
		  			</td>
				</tr>
				<tr>
					<td align="right" nowrap >经营场所:</td>
					<td>
						<select id="enterpriseAddress" name="privatePropritor.enterpriseAddress" disabled="disabled" >
				...
				<tr>
					...
					<td align="left">
		      			<input id="rent" name="privatePropritor.rent" type="text" value="${userbasic.privatePropritor.rent}" onkeyup="check(this)" disabled="disabled" />
		  			</td>
				</tr>
				<tr>
					<td align="right" nowrap >租期:</td>
					<td align="left">
		      			<input id="lease" name="privatePropritor.lease" type="text" value="${userbasic.privatePropritor.lease}" onkeyup="check(this)" disabled="disabled" />
		  			</td>
				</tr>
				<tr>
					<td align="right" nowrap >税务编号:</td>
					<td align="left">
		      			<input id="taxationNo" name="privatePropritor.taxationNo" type="text" value="${userbasic.privatePropritor.taxationNo}" onkeyup="check(this)" disabled="disabled" />
		  			</td>
				</tr>
				<tr>
					<td align="right" nowrap >工商登记号:</td>
					<td align="left">
		      			<input id="gsBookNo" name="privatePropritor.gsBookNo" type="text" value="${userbasic.privatePropritor.gsBookNo}" onkeyup="check(this)" disabled="disabled" />
		  			</td>
				</tr>
				<tr>
					<td align="right" nowrap >全年盈利/亏损额:</td>
					<td align="left">
		      			<input id="profitOrLossAmount" name="privatePropritor.profitOrLossAmount" type="text" value="${userbasic.privatePropritor.profitOrLossAmount}" onkeyup="check(this)" disabled="disabled" />
		  			</td>
				</tr>
				<tr>
					<td align="right" nowrap >雇员人数:</td>
					<td align="left">
		      			<input id="employeeAmount" name="privatePropritor.employeeAmount" type="text" value="${userbasic.privatePropritor.employeeAmount}" onkeyup="check(this)" disabled="disabled" />
		  			</td>
				</tr>
			</table>
			<input id="userId" name="userId" type="hidden" value="${userbasic.userId}" disabled="disabled" />
			<input id="id" name="privatePropritor.id" type="hidden" value="${userbasic.privatePropritor.id}" disabled="disabled" />
</form:form>