...
<form:form class="jobinputForm"  enctype="multipart/form-data" method="post" style="margin-bottom:0;">
	<table>
		<tr>
			...
			<td align="left">
				<input id="corporationName"	name="userInfoJob.corporationName" type="text"	value="${userbasic.userInfoJob.corporationName}" onkeyup="check(this)" />
			</td>
		</tr>
		<tr>
			<td align="right" nowrap>公司类别:</td>
			<td>
				<select id="corporationKind" name="userInfoJob.corporationKind">
					<option value="1"
		...
		<tr>
			...
			<td align="left">
				<select id="corporationIndustry" name="userInfoJob.corporationIndustry">
		...
		<tr>
			...
			<td align="left">
				<select id="corporationScale" name="userInfoJob.corporationScale">
		...
		<tr>
			...
			<td align="left">
				<input id="position" name="userInfoJob.position"type="text" value="${userbasic.userInfoJob.position}"	onkeyup="check(this)" />
			</td>
		</tr>
		<tr>
			<td align="right" nowrap>工作城市:</td>
			<td align="left">
					<select name="userInfoJob.jobProvince" id="jobProvince" onchange="creShiOption()">
                       ...
                       <select name="userInfoJob.jobCity" id="jobCity">
		...
		<tr>
			...
			<td align="left">
				<select id="presentCorporationWorkTime" name="userInfoJob.presentCorporationWorkTime">
		...
		<tr>
			...
			<td align="left">
				<input id=corporationPhoneArea	name="userInfoJob.corporationPhoneArea" type="text"	value="${userbasic.userInfoJob.corporationPhoneArea}" onkeyup="check(this)" /> 
				<input id=corporationPhone	name="userInfoJob.corporationPhone" type="text"	value="${userbasic.userInfoJob.corporationPhone}" onkeyup="check(this)" />
			</td>
		</tr>
		<tr>
			<td align="right" nowrap>工作邮箱:</td>
			<td align="left">
				<input id="jobEmail" name="userInfoJob.jobEmail" type="text" value="${userbasic.userInfoJob.jobEmail}"	onkeyup="check(this)" />
			</td>
		</tr>
		<tr>
			<td align="right" nowrap>公司地址:</td>
			<td align="left">
				<input id="corporationAddress"	name="userInfoJob.corporationAddress" type="text" value="${userbasic.userInfoJob.corporationAddress}" onkeyup="check(this)" />
			</td>
		</tr>
		<tr>
			<td align="right" nowrap>公司网址:</td>
			<td align="left">
				<input id="corporationWeb"	name="userInfoJob.corporationWeb" type="text" value="${userbasic.userInfoJob.corporationWeb}" onkeyup="check(this)" />
			</td>
		</tr>
	...
	<input id="infoId" name="userInfoJob.workInfoId" type="hidden" value="${userbasic.userInfoJob.workInfoId}" />
	<div style="margin:0 auto; width:80px;"><a id="jobBtn" class="easyui-linkbutton" iconCls="icon-ok">保存</a></div>
</form:form>