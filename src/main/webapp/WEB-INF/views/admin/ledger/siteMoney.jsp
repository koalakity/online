		     ...
		     if(r){
				$('#fm').form('submit', {
					...
					success : function(result) {
						...
						if (result.success) {
							window.location='${ctx}/admin/ledger/siteMoneyJsp';
						} else {
							$.messager.show({
								title : '错误',
								msg : result.msg
...
<body>
	<table id="dg" title="网站资金账户" class="easyui-datagrid" url="${ctx}/admin/ledger/siteFlowPage" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true" nowrap="false">
		<thead>
			<tr>
	...
	<div id="toolbar" style="height:42px; padding:10px 5px 5px; line-height:1.5em;">
		&nbsp;<label>网站资金账户余额:</label>&nbsp;${siteBalance}&nbsp;&nbsp;
	...
	<div id="dlg" modal="true" class="easyui-dialog" style="width: 400px; height: 380px; padding: 10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label style="text-align:right;">调账金额:</label> <input id="payAmt" name="payAmt" class="easyui-numberbox" data-options="min:0.01,precision:2,required:true">
			</div>
			<div class="fitem">
				<label style="text-align:right;">收款人:</label> <input id="receiverEmail"  name="receiverEmail" class="easyui-validatebox" required="true" validType="email">
			</div>
			<div class="fitem">
				<label style="text-align:right; vertical-align:top;">备注:</label>
