...
<script type="text/javascript">
 ...
 var exam = [
	...
	function confirm1(){
		...
		$.messager.confirm('确定', '审核通过后此信息将进入终定列表，您确定要提交吗？',function(r){
		    if(r){
		      var dataJson=JSON.stringify(dataAry);
		      $.post(
		         "${ctx}/admin/audit/auditPass?userId=${userAuditInfo.userId}&auditId=2&creditAmount="+amount,
		          {
		           dataAry : dataJson
		         },
		         function(data,textStatus){
		           location.href='${ctx}/admin/audit/firstForAuditingUserPageJsp';
		         },"json");
		    }
		});
	}
...
<div id="tt" class="easyui-tabs">
 <div title="审核信息">
 <div style="margin-bottom:10px;">信用额度：<input id="creditAmountTxt" type="text" value="${userAuditInfo.creditAmount}" />元</div>
