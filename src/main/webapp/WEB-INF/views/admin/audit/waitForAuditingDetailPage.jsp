...
function confirm1() {
    ...
    function(r) {
        if (r) {
            $.post('${ctx}/admin/audit/auditPass?userId=${userAuditInfo.userId}&auditId=1&creditAmount=0', {
    ...
    $('<div/>').dialog({
        ...
        buttons: [{
            ...
            handler: function() {
                ...
                $.post("${ctx}/admin/audit/auditReject", {
    ...
    $('<div/>').dialog({
        ...
        buttons: [{
            ...
            handler: function() {
                ...
                $.post("${ctx}/admin/audit/auditReplenish", {
                       userId :${userAuditInfo.userId},
			           cause   : replenishText,
			           operateNode : '待审'
                },
...
function save() {
    ...
    $.post("${ctx}/admin/audit/auditSave?userId=${userAuditInfo.userId}", {
        dataAry: JSON.stringify(dataAry)
    },
    function(data, textStatus) {
        location.href = '${ctx}/admin/audit/waitForAuditingUserPageJsp';
...
function openPic1(path, name, type) {
    $.post("${ctx}/admin/audit/openFile?openFilePath=" + path + "&openFileName=" + name + "&userId=${userAuditInfo.userId}",
    function(result) {
        count++;
        picCount++;
        if (count > 10) {
...
<div id="tt" class="easyui-tabs">
 <div title="审核信息">
  <div style="margin-bottom:10px;">信用评分总和：<input id="creditTotle" type="text" value="${userAuditInfo.creditGradeTotle}" disabled="disabled"/></div>
   <table id="infoApprove" class="m_defined" width="100%">
		<tr>
		...
		<tr>
		  ...
		  <td align="center">&nbsp;</td>
		  <td align="center">
		      <input id="16" name="creditGrade" type="text" value="${userAuditInfo.basicInfoApprove.creditScore}" onkeyup="check(this)"/>
		  </td>
		  <td align="center">
		...
		<tr>
		  ...
		  <td align="center" class="fileClass">
		    <c:forTokens var="name" items="${userAuditInfo.cardUserApprove.cardPath}" delims="," varStatus="status" >
		      ...
		      <a href="#" onclick="showPic('1','${fn:substringBefore(name,";")}','${userAuditInfo.email}','${userAuditInfo.userId}','idCardCertificate')" >身份认证${status.index+1}</a> 
		    ...
		    <c:choose>
		     <c:when test="${userAuditInfo.cardUserApprove.cardPath!=null}">
		       <td align="center" >
		          <input id="1" name="creditGrade" type="text" value="${userAuditInfo.cardUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		       <td align="center">
		...
		<tr>
		  ...
		  <c:choose>
		     <c:when test="${userAuditInfo.workUserApprove.cardPath!=null}">
		       <td align="center" >
		          <input id="2"  name="creditGrade" type="text" value="${userAuditInfo.workUserApprove.creditScore}" onkeyup="check(this)"/>
		        </td>
		        <td align="center">
		  ...
		  <td align="center">
		    ...
		    <c:choose>
		     <c:when test="${userAuditInfo.creditReportUserApprove.cardPath!=null}">
		       <td align="center" >
		         <input id="4" name="creditGrade" type="text" value="${userAuditInfo.creditReportUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		  ...
		  <td align="center">
		   ...
		   <c:choose>
		     <c:when test="${userAuditInfo.earnUserApprove.cardPath!=null}">
		       <td align="center" >
		         <input id="3" name="creditGrade" type="text" value="${userAuditInfo.earnUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		  ...
		  <td align="center">
		   ...
		   <c:choose>
		     <c:when test="${userAuditInfo.houseUserApprove.cardPath!=null}">
		       <td align="center" >
		         <input id="5" name="creditGrade" type="text" value="${userAuditInfo.houseUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		...
		<tr>
		  ...
		  <c:choose>
		     <c:when test="${userAuditInfo.carUserApprove.cardPath!=null}">
		       <td align="center" >
		         <input id="7" name="creditGrade" type="text" value="${userAuditInfo.carUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		  ...
		  <td align="center">
		   ...
		   <c:choose>
		     <c:when test="${userAuditInfo.marryUserApprove.cardPath!=null}">
		       <td align="center" >
		         <input id="8" name="creditGrade" type="text" value="${userAuditInfo.marryUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		...
		<tr>
		  ...
		  <c:choose>
		     <c:when test="${userAuditInfo.educationUserApprove!=null}">
		       <td align="center" >
		         <input id="12" name="creditGrade" type="text" value="${userAuditInfo.educationUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		...
		<tr>
		  ...
		  <c:choose>
		     <c:when test="${userAuditInfo.addressUserApprove.cardPath!=null}">
		       <td align="center" >
		         <input id="9" name="creditGrade" type="text" value="${userAuditInfo.addressUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		  ...
		  <td align="center">
		   ...
		   <c:choose>
		     <c:when test="${userAuditInfo.techUserApprove.cardPath!=null}">
		       <td align="center" >
		         <input id="6" name="creditGrade" type="text" value="${userAuditInfo.techUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		  ...
		  <td align="center">&nbsp;</td>
		   <c:choose>
		     <c:when test="${userAuditInfo.videoUserApprove!=null}">
		       <td align="center" >
		         <input id="10" name="creditGrade" type="text" value="${userAuditInfo.videoUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		...
		<tr>
		  ...
		  <c:choose>
		     <c:when test="${userAuditInfo.phoneUserApprove.cardPath!=null}">
		       <td align="center" >
		         <input id="13" name="creditGrade" type="text" value="${userAuditInfo.phoneUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		  ...
		  <td align="center">${userAuditInfo.userInfoPerson.sinaWeiboAccount}</td>
		   <c:choose>
		     <c:when test="${userAuditInfo.blogUserApprove!=null}">
		       <td align="center" >
		         <input id="14" name="creditGrade" type="text" value="${userAuditInfo.blogUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
		  ...
		  <td align="center">&nbsp;</td>
		   <c:choose>
		     <c:when test="${userAuditInfo.fieldVisitUserApprove!=null}">
		       <td align="center" >
		         <input id="11" name="creditGrade" type="text" value="${userAuditInfo.fieldVisitUserApprove.creditScore}" onkeyup="check(this)"/>
		       </td>
		        <td align="center">
	...
	<div style="width:850px; margin:15px 0; text-align:center;">
