...
<script type="text/javascript">
	...
	function formatterOperation(val, row) {
		url='${ctx}/admin/audit/firstForAuditingDetailPageJsp?userId='+row.userId;
...
<body>
<table id="firstAuditTbl" title="初审列表" class="easyui-datagrid"
			url="${ctx}/admin/audit/waitAuditUserPage?auditId=1"
