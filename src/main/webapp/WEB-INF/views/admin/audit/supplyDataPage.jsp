...
<script type="text/javascript">
	...
	function formatterOperation(val, row) {
		url='${ctx}/admin/audit/supplyDataDetailPageJsp?userId='+row.userId;
...
<body>
<table id="firstAuditTbl" title="补充资料列表" class="easyui-datagrid"
			url="${ctx}/admin/audit/waitAuditUserPage?auditId=4"
